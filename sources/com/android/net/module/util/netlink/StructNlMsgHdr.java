...
public class StructNlMsgHdr {
    ...
    public String toString(Integer nlFamily) {
        String typeStr = "" + ((int) this.nlmsg_type) + "(" + (nlFamily == null ? "" : NetlinkConstants.stringForNlMsgType(this.nlmsg_type, nlFamily.intValue())) + ")";
