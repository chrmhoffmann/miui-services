...
public final class MiuiFreeFormSpringForce implements Force {
    ...
    private final MiuiFreeFormDynamicAnimation.MassState mMassState;
    double mNaturalFreq;
    ...
    public MiuiFreeFormSpringForce() {
        ...
        this.mMassState = new MiuiFreeFormDynamicAnimation.MassState();
    }
    ...
    public MiuiFreeFormSpringForce setStiffness(float stiffness) {
        if (stiffness <= MiuiFreeformPinManagerService.EDGE_AREA) {
    ...
    public MiuiFreeFormSpringForce setDampingRatio(float dampingRatio) {
        if (dampingRatio < MiuiFreeformPinManagerService.EDGE_AREA) {
    ...
    @Override // com.android.server.wm.Force
