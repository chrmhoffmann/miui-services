...
public class MiuiCvwRadiateImageView extends View {
    ...
    public MiuiCvwRadiateImageView(Context context) {
        super(context);
        init();
    }

    public MiuiCvwRadiateImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (bitmap != null) {
            shadowDiameter = Math.max(shadowDiameter, bitmap.getHeight());
        }
        ...
        this.mBlurIconTop = (int) ((measuredHeight - ((shadowDiameter * 1.0f) / 2.0f)) + 0.5f);
        this.mIconLeft = (int) ((i - ((iconWidth * 1.0f) / 2.0f)) + 0.5f);
        this.mIconTop = (int) ((measuredHeight - ((iconHeight * 1.0f) / 2.0f)) + 0.5f);
    ...
    public void showIcon(Bitmap icon, int w, int h, int shadowDiameter, int blurRatio) {
        ...
        int i2 = this.mHeight;
        this.centerY = i2 / 2;
        int max = shadowDiameter > 0 ? shadowDiameter : Math.max(i, i2);
        this.mShadowDiameter = max;
        this.mShadowDiameter = Math.max(max, this.mRadiateBit.getHeight());
        this.mBlurRatio = blurRatio > 0 ? blurRatio : 25;
        int i3 = this.centerX;
        this.mBlurIconLeft = (int) ((i3 - ((shadowDiameter * 1.0f) / 2.0f)) + 0.5f);
        int i4 = this.centerY;
        this.mBlurIconTop = (int) ((i4 - ((shadowDiameter * 1.0f) / 2.0f)) + 0.5f);
        int i5 = w > 0 ? w : ICON_W_H_THRESHOLD;
        this.mIconWidth = i5;
        int i6 = h > 0 ? h : ICON_W_H_THRESHOLD;
        this.mIconHeight = i6;
        this.mIconLeft = (int) ((i3 - ((i5 * 1.0f) / 2.0f)) + 0.5f);
        this.mIconTop = (int) ((i4 - ((i6 * 1.0f) / 2.0f)) + 0.5f);
        this.mRadiateBit = radiate(getContext(), this.mIconBit);
        invalidate();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Bitmap bitmap = this.mRadiateBit;
        if (bitmap != null) {
            this.mShadowDiameter = Math.max(max, bitmap.getHeight());
        }
        int i = this.mShadowDiameter;
        this.mBlurIconLeft = (int) ((this.centerX - ((i * 1.0f) / 2.0f)) + 0.5f);
        this.mBlurIconTop = (int) ((this.centerY - ((i * 1.0f) / 2.0f)) + 0.5f);
    }
