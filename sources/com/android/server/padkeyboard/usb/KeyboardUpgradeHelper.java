...
public class KeyboardUpgradeHelper extends UpgradeHelper {
    ...
    protected byte[] mLengthByte = new byte[4];
    protected byte[] mStartAddressByte = new byte[4];
    protected byte[] mCheckSumByte = new byte[1];
    protected byte[] mVersionByte = new byte[2];
